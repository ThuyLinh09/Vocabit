...
import com.example.vocabit.databinding.ActivityImageQuestionBinding;
import com.example.vocabit.di.component.ActivityComponent;
import com.example.vocabit.ui.base.activity.BaseActivity;

public class ImageQuestionActivity extends BaseActivity<ActivityImageQuestionBinding, ImageQuestionViewModel> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewBinding.setImageQuestionActivity(this);
        viewBinding.setImageQuestionViewModel(viewModel);
        ...
        viewModel.getCurrentQuestion().observe(this, new Observer<ImageQuestionResponse>() {
            @Override
            public void onChanged(ImageQuestionResponse question) {
                if (question == null) {
                    Toast.makeText(ImageQuestionActivity.this, "Hoàn thành tất cả câu hỏi", Toast.LENGTH_SHORT).show();
                    finish();
                    return;
                }
    ...
    public int getLayoutId() {
        return R.layout.activity_image_question;
    }
