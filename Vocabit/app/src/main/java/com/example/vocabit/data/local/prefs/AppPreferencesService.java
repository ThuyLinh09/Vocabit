...
public class AppPreferencesService implements PreferencesService {
    ...
    public String getBasicAuth() {
        return mPrefs.getString(KEY_BASIC_AUTH, Constants.VALUE_BASIC_AUTH_DEFAULT);
    }
    @Override
    ...
    @Override
    public void setRole(Long userRole) {
        mPrefs.edit().putLong("USER_ROLE", userRole).apply();
    }

    @Override
    public Long getRole() {
        return mPrefs.getLong("USER_ROLE", 0);
    }

    @Override
    public void setUserId(Long userId) {
        mPrefs.edit().putLong("USER_ID", userId).apply();
    }
